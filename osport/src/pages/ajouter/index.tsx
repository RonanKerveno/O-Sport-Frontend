...
export default function Ajouter() {
  ...
  return (
    <>
      <div>
        <div className="text-center border"><h1>Ajouter un évènement</h1></div>
      </div>
      <div>
        <div className="border-2 text-[#b430a6] text-center"><h1>Evénement {id}</h1></div>
        <div className="border-2">
          <div className="flex flex-row space-x-80">
            <span className="flex flex-col"><input type="number" max={35} min={1} name="numberofuser" className="border-2" /> <HiUserGroup /></span>
